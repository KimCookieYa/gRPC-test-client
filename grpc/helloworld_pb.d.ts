...
export class TruckerLocationRequest extends jspb.Message {
    ...
    static toObject(
        ...
        msg: TruckerLocationRequest
    ): TruckerLocationRequest.AsObject;
...
export class TruckerLocationReply extends jspb.Message {
    ...
    static toObject(
        includeInstance: boolean,
        msg: TruckerLocationReply
    ): TruckerLocationReply.AsObject;
    static serializeBinaryToWriter(
...
export class TruckerLocationInAreaRequest extends jspb.Message {
    ...
    static toObject(
        includeInstance: boolean,
        msg: TruckerLocationInAreaRequest
    ): TruckerLocationInAreaRequest.AsObject;
    static serializeBinaryToWriter(
...
export class TruckerLocationInAreaReply extends jspb.Message {
    ...
    static toObject(
        includeInstance: boolean,
        msg: TruckerLocationInAreaReply
    ): TruckerLocationInAreaReply.AsObject;
    static serializeBinaryToWriter(
